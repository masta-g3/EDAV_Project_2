...
We plot the average phi through years with the dashed smooth line. Aligned X-axis, ave_phi is increasing. Does the number of floods share a same trend? We then plot twos figures to show that based on different types of magnitude, extreme (M>6) and large (M>4).
...
The results show that M4 and M6 are increasing with periodicity and some variances, but after 2010, M4 has a tendancy of decreasing, while M6 still keeps in a high leverl.
